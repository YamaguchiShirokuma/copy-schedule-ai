...
export const eventCategories = ['interview','briefing','deadline','web_test','lab','part_time_job','other'] as const;
...
export const extractEventsResponseSchema = z.object({ events: z.array(extractedCalendarEventSchema), globalAmbiguityNotes: z.array(z.string()) });
export const extractEventsRequestSchema = z.object({ text: z.string().min(1), receivedDate: z.string().optional().nullable(), timeZone: z.string().default('Asia/Tokyo') });
